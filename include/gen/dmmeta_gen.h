...
enum dmmeta_FieldIdEnum {                        // dmmeta.FieldId.value
    ...
    ,dmmeta_FieldId_textcall              = 58
    ,dmmeta_FieldId_dispatch_msg          = 59
    ,dmmeta_FieldId_match_all             = 60
    ,dmmeta_FieldId_dispsig               = 61
    ,dmmeta_FieldId_signature             = 62
    ,dmmeta_FieldId_cycle                 = 63
    ,dmmeta_FieldId_fastenc               = 64
    ,dmmeta_FieldId_fastinstr             = 65
    ,dmmeta_FieldId_fastop                = 66
    ,dmmeta_FieldId_stripcomment          = 67
    ,dmmeta_FieldId_fbufdir               = 68
    ,dmmeta_FieldId_max                   = 69
    ,dmmeta_FieldId_fbuftype              = 70
    ,dmmeta_FieldId_insready              = 71
    ,dmmeta_FieldId_inseof                = 72
    ,dmmeta_FieldId_iotype                = 73
    ,dmmeta_FieldId_fbufiotype            = 74
    ,dmmeta_FieldId_skipbytes             = 75
    ,dmmeta_FieldId_fcmap                 = 76
    ,dmmeta_FieldId_leftField             = 77
    ,dmmeta_FieldId_leftVal               = 78
    ,dmmeta_FieldId_rightVal              = 79
    ,dmmeta_FieldId_rightField            = 80
    ,dmmeta_FieldId_bidir                 = 81
    ,dmmeta_FieldId_basecmdline           = 82
    ,dmmeta_FieldId_versionsort           = 83
    ,dmmeta_FieldId_casesens              = 84
    ,dmmeta_FieldId_fconst                = 85
    ,dmmeta_FieldId_value                 = 86
    ,dmmeta_FieldId_fcurs                 = 87
    ,dmmeta_FieldId_curstype              = 88
    ,dmmeta_FieldId_nplace                = 89
    ,dmmeta_FieldId_fixedfmt              = 90
    ,dmmeta_FieldId_fstep                 = 91
    ,dmmeta_FieldId_delay                 = 92
    ,dmmeta_FieldId_scale                 = 93
    ,dmmeta_FieldId_ffast                 = 94
    ,dmmeta_FieldId_pos                   = 95
    ,dmmeta_FieldId_optional              = 96
    ,dmmeta_FieldId_op                    = 97
    ,dmmeta_FieldId_cumulative            = 98
    ,dmmeta_FieldId_emptyval              = 99
    ,dmmeta_FieldId_arg                   = 100
    ,dmmeta_FieldId_reftype               = 101
    ,dmmeta_FieldId_update                = 102
    ,dmmeta_FieldId_versions              = 103
    ,dmmeta_FieldId_nullable_versions     = 104
    ,dmmeta_FieldId_tagged_versions       = 105
    ,dmmeta_FieldId_tag                   = 106
    ,dmmeta_FieldId_fprefix               = 107
    ,dmmeta_FieldId_partial               = 108
    ,dmmeta_FieldId_regxtype              = 109
    ,dmmeta_FieldId_sorttype              = 110
    ,dmmeta_FieldId_sortfld               = 111
    ,dmmeta_FieldId_steptype              = 112
    ,dmmeta_FieldId_func                  = 113
    ,dmmeta_FieldId_fwddecl               = 114
    ,dmmeta_FieldId_namefld               = 115
    ,dmmeta_FieldId_idfld                 = 116
    ,dmmeta_FieldId_wantenum              = 117
    ,dmmeta_FieldId_namefldctyp           = 118
    ,dmmeta_FieldId_gsymbol               = 119
    ,dmmeta_FieldId_ssimfile              = 120
    ,dmmeta_FieldId_inc                   = 121
    ,dmmeta_FieldId_symboltype            = 122
    ,dmmeta_FieldId_min                   = 123
    ,dmmeta_FieldId_kafka_type_kind       = 124
    ,dmmeta_FieldId_extra                 = 125
    ,dmmeta_FieldId_listtype              = 126
    ,dmmeta_FieldId_circular              = 127
    ,dmmeta_FieldId_haveprev              = 128
    ,dmmeta_FieldId_instail               = 129
    ,dmmeta_FieldId_havetail              = 130
    ,dmmeta_FieldId_havecount             = 131
    ,dmmeta_FieldId_logcat                = 132
    ,dmmeta_FieldId_enabled               = 133
    ,dmmeta_FieldId_builtin               = 134
    ,dmmeta_FieldId_stdout                = 135
    ,dmmeta_FieldId_maxmsg                = 136
    ,dmmeta_FieldId_window                = 137
    ,dmmeta_FieldId_ismodule              = 138
    ,dmmeta_FieldId_type                  = 139
    ,dmmeta_FieldId_xref                  = 140
    ,dmmeta_FieldId_nstype                = 141
    ,dmmeta_FieldId_license               = 142
    ,dmmeta_FieldId_nsinclude             = 143
    ,dmmeta_FieldId_sys                   = 144
    ,dmmeta_FieldId_typescript            = 145
    ,dmmeta_FieldId_gensel                = 146
    ,dmmeta_FieldId_version               = 147
    ,dmmeta_FieldId_genthrow              = 148
    ,dmmeta_FieldId_correct_getorcreate   = 149
    ,dmmeta_FieldId_pool                  = 150
    ,dmmeta_FieldId_sortxref              = 151
    ,dmmeta_FieldId_pack                  = 152
    ,dmmeta_FieldId_numtype               = 153
    ,dmmeta_FieldId_min_len               = 154
    ,dmmeta_FieldId_filter_print          = 155
    ,dmmeta_FieldId_pmaskfld_member       = 156
    ,dmmeta_FieldId_pmaskfld              = 157
    ,dmmeta_FieldId_pnew                  = 158
    ,dmmeta_FieldId_buftype               = 159
    ,dmmeta_FieldId_unique                = 160
    ,dmmeta_FieldId_heaplike              = 161
    ,dmmeta_FieldId_isval                 = 162
    ,dmmeta_FieldId_cascins               = 163
    ,dmmeta_FieldId_usebasepool           = 164
    ,dmmeta_FieldId_cancopy               = 165
    ,dmmeta_FieldId_isxref                = 166
    ,dmmeta_FieldId_del                   = 167
    ,dmmeta_FieldId_up                    = 168
    ,dmmeta_FieldId_isnew                 = 169
    ,dmmeta_FieldId_hasalloc              = 170
    ,dmmeta_FieldId_inst                  = 171
    ,dmmeta_FieldId_varlen                = 172
    ,dmmeta_FieldId_length                = 173
    ,dmmeta_FieldId_strtype               = 174
    ,dmmeta_FieldId_pad                   = 175
    ,dmmeta_FieldId_ssimns                = 176
    ,dmmeta_FieldId_ssimreq               = 177
    ,dmmeta_FieldId_parent                = 178
    ,dmmeta_FieldId_parent_field          = 179
    ,dmmeta_FieldId_parent_ctype          = 180
    ,dmmeta_FieldId_child_ssimfile        = 181
    ,dmmeta_FieldId_child_key             = 182
    ,dmmeta_FieldId_reqchild              = 183
    ,dmmeta_FieldId_maxwid                = 184
    ,dmmeta_FieldId_fixedwid1             = 185
    ,dmmeta_FieldId_fixedwid2             = 186
    ,dmmeta_FieldId_aliased               = 187
    ,dmmeta_FieldId_hashfld               = 188
    ,dmmeta_FieldId_tracefld              = 189
    ,dmmeta_FieldId_tracerec              = 190
    ,dmmeta_FieldId_userfunc              = 191
    ,dmmeta_FieldId_acrkey                = 192
    ,dmmeta_FieldId_cppname               = 193
    ,dmmeta_FieldId_inscond               = 194
    ,dmmeta_FieldId_via                   = 195
    ,dmmeta_FieldId_viafld                = 196
    ,dmmeta_FieldId_keyfld                = 197
};

enum { dmmeta_FieldIdEnum_N = 198 };
