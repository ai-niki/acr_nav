...
enum command_FieldIdEnum {                             // command.FieldId.value
    ...
    ,command_FieldId_in_dir                     = 129
    ,command_FieldId_out_dir                    = 130
    ,command_FieldId_proto                      = 131
    ,command_FieldId_showcomment                = 132
    ,command_FieldId_trace                      = 133
    ,command_FieldId_key                        = 134
    ,command_FieldId_include                    = 135
    ,command_FieldId_dot                        = 136
    ,command_FieldId_xns                        = 137
    ,command_FieldId_noinput                    = 138
    ,command_FieldId_render                     = 139
    ,command_FieldId_id                         = 140
    ,command_FieldId_file_prefix                = 141
    ,command_FieldId_nchild                     = 142
    ,command_FieldId_blocking                   = 143
    ,command_FieldId_nmsg                       = 144
    ,command_FieldId_timeout                    = 145
    ,command_FieldId_recvdelay_ns               = 146
    ,command_FieldId_senddelay_ns               = 147
    ,command_FieldId_msgsize_min                = 148
    ,command_FieldId_msgsize_max                = 149
    ,command_FieldId_bufsize                    = 150
    ,command_FieldId_recvdelay                  = 151
    ,command_FieldId_pkgdata                    = 152
    ,command_FieldId_diff                       = 153
    ,command_FieldId_push                       = 154
    ,command_FieldId_remove                     = 155
    ,command_FieldId_origin                     = 156
    ,command_FieldId_ref                        = 157
    ,command_FieldId_showrec                    = 158
    ,command_FieldId_showfile                   = 159
    ,command_FieldId_R                          = 160
    ,command_FieldId_reset                      = 161
    ,command_FieldId_checkclean                 = 162
    ,command_FieldId_stat                       = 163
    ,command_FieldId_annotate                   = 164
    ,command_FieldId_data_in                    = 165
    ,command_FieldId_binpath                    = 166
    ,command_FieldId_amctest                    = 167
    ,command_FieldId_dofork                     = 168
    ,command_FieldId_q                          = 169
    ,command_FieldId_cijob                      = 170
    ,command_FieldId_capture                    = 171
    ,command_FieldId_check_clean                = 172
    ,command_FieldId_exec                       = 173
    ,command_FieldId_astr                       = 174
    ,command_FieldId_anum                       = 175
    ,command_FieldId_adbl                       = 176
    ,command_FieldId_aflag                      = 177
    ,command_FieldId_str                        = 178
    ,command_FieldId_num                        = 179
    ,command_FieldId_dbl                        = 180
    ,command_FieldId_flag                       = 181
    ,command_FieldId_dstr                       = 182
    ,command_FieldId_dnum                       = 183
    ,command_FieldId_ddbl                       = 184
    ,command_FieldId_dflag                      = 185
    ,command_FieldId_mstr                       = 186
    ,command_FieldId_mnum                       = 187
    ,command_FieldId_mdbl                       = 188
    ,command_FieldId_amnum                      = 189
    ,command_FieldId_fconst                     = 190
    ,command_FieldId_cconst                     = 191
    ,command_FieldId_dregx                      = 192
    ,command_FieldId_dpkey                      = 193
    ,command_FieldId_comptest                   = 194
    ,command_FieldId_mdbg                       = 195
    ,command_FieldId_run                        = 196
    ...
    ,command_FieldId_dbgshell                   = 223
    ,command_FieldId_reprofile                  = 224
    ,command_FieldId_args                       = 225
    ,command_FieldId_inputfile                  = 226
    ,command_FieldId_fuzzstrat                  = 227
    ,command_FieldId_seed                       = 228
    ,command_FieldId_testprob                   = 229
    ,command_FieldId_gtblacttst                 = 230
    ,command_FieldId_mr                         = 231
    ,command_FieldId_note                       = 232
    ,command_FieldId_skip_init                  = 233
    ,command_FieldId_skip_git_init              = 234
    ,command_FieldId_ncmd                       = 235
    ,command_FieldId_nofork                     = 236
    ,command_FieldId_perf_secs                  = 237
    ,command_FieldId_pertest_timeout            = 238
    ,command_FieldId_stats                      = 239
    ,command_FieldId_enable                     = 240
    ,command_FieldId_disable                    = 241
    ,command_FieldId_gc                         = 242
    ,command_FieldId_dir                        = 243
    ,command_FieldId_hitrate                    = 244
    ,command_FieldId_after                      = 245
    ,command_FieldId_selector                   = 246
    ,command_FieldId_fields                     = 247
    ,command_FieldId_accept                     = 248
    ,command_FieldId_approve                    = 249
    ,command_FieldId_needs_work                 = 250
    ,command_FieldId_authdir                    = 251
    ,command_FieldId_gitdir                     = 252
    ,command_FieldId_show_gitlab_system_notes   = 253
    ,command_FieldId_file                       = 254
    ,command_FieldId_kv                         = 255
    ,command_FieldId_output                     = 256
    ,command_FieldId_attach                     = 257
    ,command_FieldId_pid                        = 258
    ,command_FieldId_catchthrow                 = 259
    ,command_FieldId_tui                        = 260
    ,command_FieldId_bcmd                       = 261
    ,command_FieldId_emacs                      = 262
    ,command_FieldId_manywin                    = 263
    ,command_FieldId_follow_child               = 264
    ,command_FieldId_py                         = 265
    ,command_FieldId_mp                         = 266
    ,command_FieldId_writessimfile              = 267
    ,command_FieldId_url                        = 268
    ,command_FieldId_tables                     = 269
    ,command_FieldId_nologo                     = 270
    ,command_FieldId_baddbok                    = 271
    ,command_FieldId_move                       = 272
    ,command_FieldId_dedup                      = 273
    ,command_FieldId_commit                     = 274
    ,command_FieldId_undo                       = 275
    ,command_FieldId_hash                       = 276
    ,command_FieldId_parse_make                 = 277
    ,command_FieldId_makefile                   = 278
    ,command_FieldId_expr                       = 279
    ,command_FieldId_style                      = 280
    ,command_FieldId_full                       = 281
    ,command_FieldId_f                          = 282
    ,command_FieldId_match                      = 283
    ,command_FieldId_string                     = 284
    ,command_FieldId_name                       = 285
    ,command_FieldId_files                      = 286
    ,command_FieldId_refs                       = 287
    ,command_FieldId_pull                       = 288
    ,command_FieldId_targsrc                    = 289
    ,command_FieldId_acrkey                     = 290
    ,command_FieldId_func                       = 291
    ,command_FieldId_nextfile                   = 292
    ,command_FieldId_other                      = 293
    ,command_FieldId_updateproto                = 294
    ,command_FieldId_createmissing              = 295
    ,command_FieldId_iffy                       = 296
    ,command_FieldId_gen                        = 297
    ,command_FieldId_showloc                    = 298
    ,command_FieldId_showstatic                 = 299
    ,command_FieldId_matchproto                 = 300
    ,command_FieldId_matchbody                  = 301
    ,command_FieldId_matchcomment               = 302
    ,command_FieldId_showsortkey                = 303
    ,command_FieldId_showbody                   = 304
    ,command_FieldId_sortname                   = 305
    ,command_FieldId_printssim                  = 306
    ,command_FieldId_baddecl                    = 307
    ,command_FieldId_indent                     = 308
    ,command_FieldId_update_copyright           = 309
    ,command_FieldId_scriptfile                 = 310
    ,command_FieldId_linelim                    = 311
    ,command_FieldId_strayfile                  = 312
    ,command_FieldId_badchar                    = 313
    ,command_FieldId_badline                    = 314
    ,command_FieldId_expand                     = 315
    ,command_FieldId_ignoreQuote                = 316
    ,command_FieldId_maxpacket                  = 317
    ,command_FieldId_db                         = 318
    ,command_FieldId_createdb                   = 319
    ,command_FieldId_typetag                    = 320
    ,command_FieldId_format                     = 321
    ,command_FieldId_tocamelcase                = 322
    ,command_FieldId_tolowerunder               = 323
    ,command_FieldId_pathcomp                   = 324
    ,command_FieldId_fname                      = 325
    ,command_FieldId_outseparator               = 326
    ,command_FieldId_header                     = 327
    ,command_FieldId_prefer_signed              = 328
    ,command_FieldId_value                      = 329
};

enum { command_FieldIdEnum_N = 330 };
