...
enum command_FieldIdEnum {                             // command.FieldId.value
    ...
    ,command_FieldId_in_dir                     = 130
    ,command_FieldId_out_dir                    = 131
    ,command_FieldId_proto                      = 132
    ,command_FieldId_showcomment                = 133
    ,command_FieldId_trace                      = 134
    ,command_FieldId_key                        = 135
    ,command_FieldId_include                    = 136
    ,command_FieldId_dot                        = 137
    ,command_FieldId_xns                        = 138
    ,command_FieldId_noinput                    = 139
    ,command_FieldId_render                     = 140
    ,command_FieldId_id                         = 141
    ,command_FieldId_file_prefix                = 142
    ,command_FieldId_nchild                     = 143
    ,command_FieldId_blocking                   = 144
    ,command_FieldId_nmsg                       = 145
    ,command_FieldId_timeout                    = 146
    ,command_FieldId_recvdelay_ns               = 147
    ,command_FieldId_senddelay_ns               = 148
    ,command_FieldId_msgsize_min                = 149
    ,command_FieldId_msgsize_max                = 150
    ,command_FieldId_bufsize                    = 151
    ,command_FieldId_recvdelay                  = 152
    ,command_FieldId_pkgdata                    = 153
    ,command_FieldId_diff                       = 154
    ,command_FieldId_push                       = 155
    ,command_FieldId_remove                     = 156
    ,command_FieldId_origin                     = 157
    ,command_FieldId_ref                        = 158
    ,command_FieldId_showrec                    = 159
    ,command_FieldId_showfile                   = 160
    ,command_FieldId_R                          = 161
    ,command_FieldId_reset                      = 162
    ,command_FieldId_checkclean                 = 163
    ,command_FieldId_stat                       = 164
    ,command_FieldId_annotate                   = 165
    ,command_FieldId_data_in                    = 166
    ,command_FieldId_binpath                    = 167
    ,command_FieldId_amctest                    = 168
    ,command_FieldId_dofork                     = 169
    ,command_FieldId_q                          = 170
    ,command_FieldId_cijob                      = 171
    ,command_FieldId_capture                    = 172
    ,command_FieldId_check_clean                = 173
    ,command_FieldId_exec                       = 174
    ,command_FieldId_astr                       = 175
    ,command_FieldId_anum                       = 176
    ,command_FieldId_adbl                       = 177
    ,command_FieldId_aflag                      = 178
    ,command_FieldId_str                        = 179
    ,command_FieldId_num                        = 180
    ,command_FieldId_dbl                        = 181
    ,command_FieldId_flag                       = 182
    ,command_FieldId_dstr                       = 183
    ,command_FieldId_dnum                       = 184
    ,command_FieldId_ddbl                       = 185
    ,command_FieldId_dflag                      = 186
    ,command_FieldId_mstr                       = 187
    ,command_FieldId_mnum                       = 188
    ,command_FieldId_mdbl                       = 189
    ,command_FieldId_amnum                      = 190
    ,command_FieldId_fconst                     = 191
    ,command_FieldId_cconst                     = 192
    ,command_FieldId_dregx                      = 193
    ,command_FieldId_dpkey                      = 194
    ,command_FieldId_comptest                   = 195
    ,command_FieldId_mdbg                       = 196
    ,command_FieldId_run                        = 197
    ,command_FieldId_printinput                 = 198
    ,command_FieldId_normalize                  = 199
    ,command_FieldId_covcapture                 = 200
    ,command_FieldId_covcheck                   = 201
    ,command_FieldId_bindir                     = 202
    ,command_FieldId_tempdir                    = 203
    ,command_FieldId_testdir                    = 204
    ,command_FieldId_check_untracked            = 205
    ,command_FieldId_memcheck                   = 206
    ,command_FieldId_callgrind                  = 207
    ,command_FieldId_stream                     = 208
    ,command_FieldId_i                          = 209
    ,command_FieldId_b                          = 210
    ,command_FieldId_covfast                    = 211
    ,command_FieldId_minrepeat                  = 212
    ,command_FieldId_maxrepeat                  = 213
    ,command_FieldId_covdir                     = 214
    ,command_FieldId_logfile                    = 215
    ,command_FieldId_runcmd                     = 216
    ,command_FieldId_exclude                    = 217
    ,command_FieldId_mergepath                  = 218
    ,command_FieldId_gcov                       = 219
    ,command_FieldId_ssim                       = 220
    ,command_FieldId_xmlpretty                  = 221
    ,command_FieldId_summary                    = 222
    ,command_FieldId_incremental                = 223
    ,command_FieldId_dbgshell                   = 224
    ,command_FieldId_reprofile                  = 225
    ,command_FieldId_args                       = 226
    ,command_FieldId_inputfile                  = 227
    ,command_FieldId_fuzzstrat                  = 228
    ,command_FieldId_seed                       = 229
    ,command_FieldId_testprob                   = 230
    ,command_FieldId_gtblacttst                 = 231
    ,command_FieldId_mr                         = 232
    ,command_FieldId_note                       = 233
    ,command_FieldId_skip_init                  = 234
    ,command_FieldId_skip_git_init              = 235
    ,command_FieldId_ncmd                       = 236
    ,command_FieldId_nofork                     = 237
    ,command_FieldId_perf_secs                  = 238
    ,command_FieldId_pertest_timeout            = 239
    ,command_FieldId_stats                      = 240
    ,command_FieldId_enable                     = 241
    ,command_FieldId_disable                    = 242
    ,command_FieldId_gc                         = 243
    ,command_FieldId_dir                        = 244
    ,command_FieldId_hitrate                    = 245
    ,command_FieldId_after                      = 246
    ,command_FieldId_selector                   = 247
    ,command_FieldId_fields                     = 248
    ,command_FieldId_accept                     = 249
    ,command_FieldId_approve                    = 250
    ,command_FieldId_needs_work                 = 251
    ,command_FieldId_authdir                    = 252
    ,command_FieldId_gitdir                     = 253
    ,command_FieldId_show_gitlab_system_notes   = 254
    ,command_FieldId_file                       = 255
    ,command_FieldId_kv                         = 256
    ,command_FieldId_output                     = 257
    ,command_FieldId_attach                     = 258
    ,command_FieldId_pid                        = 259
    ,command_FieldId_catchthrow                 = 260
    ,command_FieldId_tui                        = 261
    ,command_FieldId_bcmd                       = 262
    ,command_FieldId_emacs                      = 263
    ,command_FieldId_manywin                    = 264
    ,command_FieldId_follow_child               = 265
    ,command_FieldId_py                         = 266
    ,command_FieldId_mp                         = 267
    ,command_FieldId_writessimfile              = 268
    ,command_FieldId_url                        = 269
    ,command_FieldId_tables                     = 270
    ,command_FieldId_nologo                     = 271
    ,command_FieldId_baddbok                    = 272
    ,command_FieldId_move                       = 273
    ,command_FieldId_dedup                      = 274
    ,command_FieldId_commit                     = 275
    ,command_FieldId_undo                       = 276
    ,command_FieldId_hash                       = 277
    ,command_FieldId_parse_make                 = 278
    ,command_FieldId_makefile                   = 279
    ,command_FieldId_expr                       = 280
    ,command_FieldId_style                      = 281
    ,command_FieldId_full                       = 282
    ,command_FieldId_f                          = 283
    ,command_FieldId_match                      = 284
    ,command_FieldId_string                     = 285
    ,command_FieldId_name                       = 286
    ,command_FieldId_files                      = 287
    ,command_FieldId_refs                       = 288
    ,command_FieldId_pull                       = 289
    ,command_FieldId_targsrc                    = 290
    ,command_FieldId_acrkey                     = 291
    ,command_FieldId_func                       = 292
    ,command_FieldId_nextfile                   = 293
    ,command_FieldId_other                      = 294
    ,command_FieldId_updateproto                = 295
    ,command_FieldId_createmissing              = 296
    ,command_FieldId_iffy                       = 297
    ,command_FieldId_gen                        = 298
    ,command_FieldId_showloc                    = 299
    ,command_FieldId_showstatic                 = 300
    ,command_FieldId_matchproto                 = 301
    ,command_FieldId_matchbody                  = 302
    ,command_FieldId_matchcomment               = 303
    ,command_FieldId_showsortkey                = 304
    ,command_FieldId_showbody                   = 305
    ,command_FieldId_sortname                   = 306
    ,command_FieldId_printssim                  = 307
    ,command_FieldId_baddecl                    = 308
    ,command_FieldId_indent                     = 309
    ,command_FieldId_update_copyright           = 310
    ,command_FieldId_scriptfile                 = 311
    ,command_FieldId_linelim                    = 312
    ,command_FieldId_strayfile                  = 313
    ,command_FieldId_badchar                    = 314
    ,command_FieldId_badline                    = 315
    ,command_FieldId_expand                     = 316
    ,command_FieldId_ignoreQuote                = 317
    ,command_FieldId_maxpacket                  = 318
    ,command_FieldId_db                         = 319
    ,command_FieldId_createdb                   = 320
    ,command_FieldId_typetag                    = 321
    ,command_FieldId_format                     = 322
    ,command_FieldId_tocamelcase                = 323
    ,command_FieldId_tolowerunder               = 324
    ,command_FieldId_pathcomp                   = 325
    ,command_FieldId_fname                      = 326
    ,command_FieldId_outseparator               = 327
    ,command_FieldId_header                     = 328
    ,command_FieldId_prefer_signed              = 329
    ,command_FieldId_value                      = 330
};

enum { command_FieldIdEnum_N = 331 };
